...
export default function OrgDashboardLayout({ children, activeTab }: OrgDashboardLayoutProps) {
        ...
        <Sidebar className="border-r border-amber-200">
          <SidebarHeader className="border-b border-amber-200 p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h2 className="font-semibold text-amber-800">{currentOrg?.name}</h2>
                <p className="text-xs text-amber-600">Organization Admin</p>
              </div>
            </div>
          </SidebarHeader>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-amber-600">
                  {currentOrg?.name} Organization Management
                </p>
              </div>
            </div>
          </header>
